...
class EnvatoAPI
  ...
  # * Usage: myEnvatoApIInstance.get_blog_posts('activeden', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_active_threads('activeden', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_number_of_files('activeden', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_popular_items('activeden', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_user_info('activeden', 'xml')
  ...
  #   Knock yourself out.
  # * Usage: myEnvatoApIInstance.get_release_info('xml')
  ...
  # * Usage: myEnvatoApIInstance.get_thread_status('123456789', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.collection_info('123456789', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_site_features('activeden', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_new_files('graphicriver', 'site-templates', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_new_files('collis', 'themeforest', 'xml')
  ...
  # * Usage: myEnvatoApIInstance.get_total_users('activeden', 'xml')
  ...
  # third is required.
  # Examples:
  # * search:themeforest,site-templates,xml.json search:,,collis.json
  # * search:audiojungle,,happy.json
